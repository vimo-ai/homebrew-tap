# Homebrew Formula for Memex Lite
#
# Usage: brew install vimo-ai/tap/memex-lite

class MemexLite < Formula
  desc "Zero-dependency lightweight CLI for searching AI CLI session history"
